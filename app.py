...
try:
    ...
    st.error("docx2txt module not found. Please install it using: pip install docx2txt")

try:
    import PyPDF2
except ImportError:
    st.error("PyPDF2 module not found. Please install it using: pip install PyPDF2")

try:
    from reportlab.pdfgen import canvas
    from reportlab.lib.pagesizes import letter
except ImportError:
    st.error("reportlab module not found. Please install it using: pip install reportlab")
